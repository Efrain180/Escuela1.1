...
if ($query_materias->rowCount() > 0) {
    ...
    while ($row_materia = $query_materias->fetch(PDO::FETCH_ASSOC)) {
        echo '<tr>
                ...
                <td><a href="lista_alumnos.php?id_materia=' . $row_materia['id_materia'] . '&id_grupo=' . $row_materia['id_grupo'] . '" class="btn btn-success"      >Registrar Asistencias</a>
                <a href="tabla_asistencias.php?id_materia=' . $row_materia['id_materia'] . '&id_grupo=' . $row_materia['id_grupo'] . 'id_profesor=' . $id_maestro . '" class="btn btn-success"      > Ver Asistencias</a></td>
