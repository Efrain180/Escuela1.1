    ...
    <aside class="main-sidebar sidebar-dark-primary1 elevation-4">
      ...
      <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
          ...
          <div class="info">
            <a href="#"  class="d-block"><?php  print('EST. '.$row['nombrea'].' '.$row['apellido1']) ?></a>
          </div>
        </div>
      ...
      <div class="col-md-12">
        <div class="card card-green">
          <div class="card-header">
            <h3 class="card-title" class="text-center"> Perfil</h3>
          </div>
          <!-- /.card-body -->
        </div>
        <!-- /.card -->
                ...
                <div class="row">
                  <div class="col-sm-4">
                    <div class="position-relative p-3 bg-gray" style="height: 180px">
                      ...
                      <small><?php  print($row['nombrea'].' '.$row['apellido1'].' '.$row['apellido2']) ?></small>
                    </div>
                  </div>
                  <div class="col-sm-4">
                    <div class="position-relative p-3 bg-gray" style="height: 180px">
                      ...
                      <small><?php  print($row['fechana']) ?></small>
                    </div>
                  </div>
                  <div class="col-sm-4">
                    <div class="position-relative p-3 bg-gray" style="height: 180px">
                      ...
                      Correo: <br />
                      <small><?php  print($row['correo']) ?></small><br>
                      Contraseña: <br />
                      <small><?php  print($row['contrasena']) ?></small>
                    </div>
                  </div>
                </div>
              </div>
