    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      ...
      <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
          ...
          <div class="info">
            <a href="vistas/paginas/perfil.php"  class="d-block">  <?php  print('EST. '.$row['nombrea'].' '.$row['apellido1']) ?></a>
          </div>
        </div>
        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item">
              <a href="vistas/paginas/grupos.php" class="nav-link">
            ...
            <li class="nav-item">
              <a href="vistas/paginas/pago.php" class="nav-link">
                <i class="nav-icon fas fa-book"></i>
                <p>
                  Pagos
                </p>
